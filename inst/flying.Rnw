...
<<who1, echo = FALSE, message=FALSE, warning=FALSE,fig=TRUE, fig.show='hold', caption="", label=who1, width = 7, height = 7>>=
...
# read in data from fivethirtyeight github
...
names(fly) <- c("ID", "FlightFreq", "DoYouRecline", "Height", "Child18",
                "three_Seats_2Arms", "two_Seats_1Arm", "WhoControlsWindowShade",
                "RudeToMoveToUnsoldSeat", "RudeToTalkToNeighbor",
                "SixhrFlightRudeToLeaveSeat", "RecliningObligationToBehind",
                "RudeToRecline", "EliminateReclining",
                "RudeToSwitchSeatsForFriends", "RudeToSwitchSeatsForFamily",
                "RudeToWakeNeighborForBathroom", "RudeToWakeNeighborForWalk",
                "RudeToBringBaby", "RudeToBringUnrulyChild",
                "UseElectronicsDuringTakeoff", "HaveYouSmoked",
                "Gender", "Age", "HouseholdIncome", "Education", "Region")



# change the order of the levels of household income
...
# change the order of the levels of flight frequency
...
# flight frequency by household income
ggplot(data = fly) +
  geom_mosaic(aes(x=product(HouseholdIncome), fill=FlightFreq), divider=ddecker(), na.rm=T) +
  guides(fill=guide_legend(reverse = TRUE)) +
  labs(x="Household Income", title="How frequently do you fly?", subtitle="Broken down by household income") +   theme(axis.text.x = element_text(angle=90), legend.position="bottom")
...
<<who2, echo = FALSE, message=FALSE, warning=FALSE,fig=TRUE, fig.show='hold', fig.cap="Who?", width = 7, height = 7>>=
...
ggplot(data = fly) +
  ...
  guides(fill=guide_legend( reverse = TRUE)) +
  labs(x="Education level", title="How frequently do you fly?", subtitle="Broken down by education level") +   theme(axis.text.x = element_text(angle=90), legend.position="bottom")#+   scale_fill_viridis(discrete=TRUE, option="B", begin=.2, end=.9)
@
...
<<who3, echo = FALSE, message=FALSE, warning=FALSE,fig=TRUE, fig.show='hold', fig.cap="I", width = 7, height = 7>>=
ggplot(data = fly) +
  geom_mosaic(aes(x=product(Age), fill=FlightFreq), divider=ddecker(), na.rm=T) +
  facet_grid(~Gender) +
  guides(fill=guide_legend( reverse = TRUE)) +
  labs(x="Age Bracket", title="How frequently do you fly?", subtitle="Broken down by age bracket within each gender") +   theme(axis.text.x = element_text(angle=90), legend.position="bottom") #+   scale_fill_viridis(discrete=TRUE, option="B", begin=.2, end=.9)
@
...
<<label=recline1, echo = FALSE, message=FALSE, warning=FALSE,fig=TRUE, fig.cap="Is it rude to recline your seat?", width=7, height=14>>=
...
set.separators(c(":", ";","|"))
library(gridExtra)
a <- ggplot(data = fly) + geom_mosaic(aes(x=product(DoYouRecline)), fill="#d95f02", na.rm=T, divider="hbar")  +  guides(fill=guide_legend( reverse = TRUE))  +  scale_fill_brewer(palette = "Dark2", direction = -1)+labs(x="Is it rude to recline?", title="Do you recline your seat?")  +   theme(axis.text.x = element_text(angle=90), legend.position="bottom")

b <- ggplot(data = fly) + geom_mosaic(aes(x=product(RudeToRecline)), fill="#1b9e77", na.rm=T, divider="hbar")  +  guides(fill=guide_legend( reverse = TRUE))  +  scale_fill_brewer(palette = "Dark2", direction = -1)+labs(x="Is it rude to recline?", title="Is it rude to recline your seat?")  +   theme(axis.text.x = element_text(angle=90), legend.position="bottom")
...
<<label=recline, echo = FALSE, message=FALSE, warning=FALSE,fig=TRUE, fig.show='hold', fig.cap="Is it rude to recline your seat?", width=7, height=7>>=
...
ggplot(data = fly) + geom_mosaic(aes(x=product(RudeToRecline), fill=DoYouRecline), na.rm=T)  +  guides(fill=guide_legend( reverse = TRUE))  +  scale_fill_brewer(palette = "Dark2", direction = -1)+labs(x="Is it rude to recline?", title="Do you recline your seat?", subtitle="Broken down by response to 'Is it rude to recline?'")  +   theme(axis.text.x = element_text(angle=90), legend.position="bottom")

#ggplot(data = fly) + geom_mosaic(aes(x=product(RecliningObligationToBehind), fill=DoYouRecline), na.rm=T)
@

<<label=eliminate, echo = FALSE, message=FALSE, warning=FALSE,fig=TRUE, fig.show='hold', fig.cap="Is it rude to recline your seat?", width=7, height=7>>=

# change order of the levels



ggplot(data = fly) + geom_mosaic(aes(x=product(RudeToRecline), fill=EliminateReclining), na.rm=T)  +  guides(fill=guide_legend( reverse = TRUE))  +  scale_fill_brewer(palette = "Dark2", direction = -1)+labs(x="Is it rude to recline?", title="Should reclining be eliminated?", subtitle="Broken down by response to 'Is it rude to recline?'")  +   theme(axis.text.x = element_text(angle=90), legend.position="bottom")
...
<<label=baby, echo = FALSE, message=FALSE, warning=FALSE, fig=TRUE,  fig.cap="S .", fig.pos='h', width = 7, height = 7>>=
ggplot(data = fly) + geom_mosaic(aes(x=product(RudeToBringBaby), fill=RudeToBringBaby), na.rm=T, divider="hbar") +
  guides(fill=guide_legend( reverse = TRUE))  +  #scale_fill_viridis(discrete=TRUE, option="D", begin=.2, end=.9)+
   scale_fill_brewer(palette = "Set1", direction=-1)+
  labs(x="Gender, Child under 18", title="Is it rude to bring a baby?", subtitle="Broken down by whether respondent has a child under 18 and gender") +   theme(axis.text.x = element_text(angle=90), legend.position="bottom")
@
...
<<label=baby2, echo = FALSE, message=FALSE, warning=FALSE, fig=TRUE,  fig.cap="S .", fig.pos='h', width = 7, height = 7>>=
...
<<label=child, echo = FALSE, message=FALSE, warning=FALSE, fig=TRUE,  fig.cap="S .", fig.pos='h', width = 8, height = 5>>=
ggplot(data = fly) + geom_mosaic(aes(x=product(RudeToBringUnrulyChild), fill=RudeToBringUnrulyChild), na.rm=T, divider="hbar") +
  guides(fill=guide_legend( reverse = TRUE))  +  #scale_fill_viridis(discrete=TRUE, option="D", begin=.2, end=.9)+
   scale_fill_brewer(palette = "Set1", direction=-1)+
  labs(x="Gender, Child under 18", title="Is it rude to bring an unruly child?") +   theme(axis.text.x = element_text(angle=90), legend.position="bottom")
@
\setkeys{Gin}{width=0.45\textwidth}
...
<<child2, echo = FALSE, message=FALSE, warning=FALSE,fig=TRUE,  fig.cap="S .", fig.pos='h', width = 7, height = 7>>=
ggplot(data = fly) + geom_mosaic(aes(x=product(Gender, Child18), fill=RudeToBringUnrulyChild), na.rm=T, divider=ddecker()) +
  guides(fill=guide_legend( reverse = TRUE)) +  scale_fill_brewer(palette = "Set1", direction=-1)+labs(x="Gender, Child under 18", title="Is it rude to bring an unruly child?", subtitle="Broken down by whether respondent has a child under 18 and gender")+   theme(axis.text.x = element_text(angle=90), legend.position="bottom")

@


<<age_baby, echo = FALSE, message=FALSE, warning=FALSE,fig=TRUE,  fig.cap="S .", fig.pos='h', width = 7, height = 7>>=
ggplot(data = fly) + geom_mosaic(aes(x=product(Age), fill=RudeToBringBaby),                                  divider=ddecker(), na.rm=T)+
  guides(fill=guide_legend( reverse = TRUE)) + scale_fill_brewer(palette = "Set1", direction=-1)+labs(x="Age Bracket", title="Is it rude to bring a baby on a plane?", subtitle="Responses broken down by age bracket")+   theme(axis.text.x = element_text(angle=90), legend.position="bottom")
@

<<age_child, echo = FALSE, message=FALSE, warning=FALSE,fig=TRUE,  fig.cap="S .", fig.pos='h', width = 7, height = 7>>=
ggplot(data = fly) + geom_mosaic(aes(x=product(Age), fill=RudeToBringUnrulyChild),                                  divider=ddecker(), na.rm=T)+
  guides(fill=guide_legend( reverse = TRUE)) +  scale_fill_brewer(palette = "Set1", direction=-1)+labs(x="Age Bracket", title="Is it rude to bring an unruly child on a plane?", subtitle="Responses broken down by age bracket")+   theme(axis.text.x = element_text(angle=90), legend.position="bottom")
@
